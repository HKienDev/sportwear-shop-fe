      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
        ...
        <div className="space-y-4 min-h-[180px]">
          <div className="flex items-center space-x-3">
            ...
            />
            <span className="text-2xl font-bold bg-gradient-to-r from-purple-600 to-red-600 bg-clip-text text-transparent font-sans">
              VJU SPORT
            </span>
          </div>
          ...
          <div className="flex space-x-4">
            <a 
              ...
              aria-label="Facebook"
            >
              <Facebook size={24} style={{ width: 24, height: 24 }} />
            </a>
            <a 
            ...
            >
              <Instagram size={24} style={{ width: 24, height: 24 }} />
            </a>
            <a 
              ...
              aria-label="Twitter"
            >
              <Twitter size={24} style={{ width: 24, height: 24 }} />
            </a>
          </div>
        </div>

        {/* Quick Links */}
        <div className="min-h-[180px] font-sans">
        ...
        <div className="min-h-[180px] font-sans">
          ...
          <ul className="space-y-2">
            <li className="flex items-center text-gray-600">
              <Phone size={20} style={{ width: 20, height: 20 }} className="mr-2" />
