      ...
      <div className={`container max-w-4xl flex flex-col md:flex-row items-center justify-between gap-12 px-6 py-16 z-10 transition-all duration-1000 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
          ...
          <div className="relative w-72 h-72 mb-6">
            ...
            <div className="absolute inset-8 flex items-center justify-center">
              <div className="relative h-full w-full flex items-center justify-center">
                {/* 50 creative display */}
                <span className="text-8xl font-bold text-white bg-red-500 px-6 py-3 rounded-lg shadow-lg transform -rotate-6">5</span>
                ...
                <span className="text-8xl font-bold text-white bg-red-500 px-6 py-3 rounded-lg shadow-lg transform rotate-6">0</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full md:w-1/2 text-center md:text-left">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-gray-900 mb-4">
            <span className="text-red-500">Lỗi</span> máy chủ
          </h1>
          
          <p className="text-lg text-gray-600 mb-8 leading-relaxed">
            Xin lỗi, đã có lỗi xảy ra trên máy chủ. Vui lòng thử lại sau hoặc liên hệ với chúng tôi nếu vấn đề vẫn tiếp tục.
          </p>
