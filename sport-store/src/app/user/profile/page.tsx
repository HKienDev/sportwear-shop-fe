...
import ProfileUser from "@/app/user/profile/ProfileUser/page";
      ...
      <div className="mt-6">
        ...
        <div className="border rounded">
          ...
          <div className="flex justify-center p-3 gap-1">
            ...
            <button className="w-8 h-8 flex items-center justify-center border rounded bg-blue-500 text-white">1</button>
          ...
          <table className="min-w-full">
            ...
            <tbody>
              {[...Array(8)].map((_, index) => (
                <tr key={index} className="border-t">
                  <td className="p-3">
                    <a href="#" className="text-blue-500 hover:underline">#2131</a>
                  </td>
