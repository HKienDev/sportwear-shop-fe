              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                  ...
                  <p className="text-indigo-100 mt-3 max-w-2xl text-lg">
                    Xem và quản lý tất cả sản phẩm trong hệ thống với giao diện hiện đại
                  </p>
                </div>
            ...
            <div className="relative bg-white/90 backdrop-blur-sm rounded-2xl border border-rose-100/60 shadow-xl p-6">
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <span className="text-slate-700 font-semibold">sản phẩm đã được chọn</span>
          ...
          {isLoading ? (
            ...
            <div className="relative bg-white/90 backdrop-blur-sm rounded-3xl border border-indigo-100/60 shadow-xl p-12">
              <div className="flex flex-col items-center justify-center text-center">
                ...
                <h3 className="text-2xl font-bold text-slate-800 mb-3">Không tìm thấy sản phẩm</h3>
                <p className="text-slate-600 max-w-md mb-6 text-lg">
                  Hiện không có sản phẩm nào phù hợp với điều kiện tìm kiếm của bạn. 
                  Hãy thử điều chỉnh bộ lọc hoặc tạo sản phẩm mới.
                </p>
                <div className="flex flex-col sm:flex-row gap-3">
                  <button 
